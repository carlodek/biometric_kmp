...
import it.carlo.de.chellis.biometrickmp.KindOfPlatform
...
import it.carlo.de.chellis.biometrickmp.getPlatform
...
fun AuthenticateScreen(
    ...
    val currentPlatform = getPlatform().kindOfPlatform
    HeaderComposable(
        header = Header(
            title = Greeting().greet(),
            imageDx = if (currentPlatform == KindOfPlatform.Desktop)
                null
            else
                Header.HeaderImage(
